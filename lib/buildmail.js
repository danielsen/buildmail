 ...
 */
MimeNode.prototype.setHeader = function (key, value, bypass) {
  var added = false,
    headerValue;
 ...
 * @return {Object} current node
 */
MimeNode.prototype.addHeader = function (key, value, bypass) {
 ...
 * @return {Object} current node
 */
MimeNode.prototype.setContent = function (content, bypass) {
  var _self = this;
  ...
  if (typeof this.content.pipe === 'function') {
    ...
    if (this._isPlainText && libmime.hasLongerLines(this.content, 76)) {
      ...
      // unless the bypass parameter is true. In that case, proceed
...
MimeNode.prototype.buildHeaders = function () {
  ...
  this._headers.forEach(function (header) {
    ...
    value = _self._encodeHeaderValue(key, value, bypass);
...
MimeNode.prototype._generateBoundary = function () {
  return '----ZGFuaWVsc2Vu-?=_' + this._nodeId + '-' 
 ...
 * @param {String} value Header value
 * @param {Bool}    bypass Bypass flag for structured headers. Adding this
 *                         flag will set the header as-is with no attempts
 *                         to convert or parse addresses. Use with caution
 */
MimeNode.prototype._encodeHeaderValue = function (key, value, bypass) {
  key = this._normalizeHeaderKey(key);
